...
export function SideBar() {
  return (
    <div className="cont flex flex-col text-xs gap-8 ml-6 mr-5 max-xs:hidden">
        ...
        <button className="text-xxs">
          ...
          >
            <path
              ...
              className="shorts_svg_path1 active_shorts_svg_path1"
            ></path>
            <path
              className="shorts_svg_path2 active_shorts_svg_path2"
              fill="#000"
